...
import {
  ColorDef, ColorDefProps, Gradient, GraphicParams, ImageBuffer, ImageBufferFormat, RenderTexture, TextureMapping, TextureTransparency, ThematicGradientColorScheme, ThematicGradientMode, ThematicGradientSettings
...
export default class HeatmapDecorator implements Decorator {
  ...
  private _createGraphics(context: DecorateContext): RenderGraphic | undefined {
    ...
    const material = IModelApp.renderSystem.createRenderMaterial({
      textureMapping,
      source: {
        id: context.viewport.iModel.transientIds.getNext(),
        iModel: context.viewport.iModel,
      },
    });

    // const material = IModelApp.renderSystem.createRenderMaterial(materialParams, context.viewport.iModel);
