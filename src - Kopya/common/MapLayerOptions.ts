...
export const mapLayerOptions: MapLayerOptions = {
  ...
  BingMaps: {
    key: "key",
    value: process.env.IMJS_BING_MAPS_KEY || "Aoi34HHd6h-rU7c065J2luy8W_EqT769AyM0Jq33ogiZq7TH0OgBSaedElmSO-eF",
  },

  // Access token for Map Box service. For more information: https://docs.mapbox.com/help/getting-started/access-tokens
  MapboxImagery: {
    key: "access_token",
    value: process.env.IMJS_MAP_BOX_KEY || "pk.eyJ1IjoiY2VyZW56ZW5naW4iLCJhIjoiY2xxY2hmdW56MDI3djJrcnFmdnVzd2c0ciJ9.sjfCZCqWpU9NNOYp1tjcNw",
  },
};
